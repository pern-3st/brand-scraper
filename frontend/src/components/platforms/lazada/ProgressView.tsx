...
import { DoneInfo, LazadaProductRecord, LogEntry } from "@/types";
...
const LAZADA_COLUMNS = productRecordColumns("lazada");

interface ProgressViewProps {
  products: LazadaProductRecord[];
  logs: LogEntry[];
    ...
    <div className="space-y-4">
      <div className="rounded-2xl bg-card p-6 shadow-md shadow-accent/5 ring-1 ring-border">
        <div className="flex items-start justify-between gap-4">
          <div>
            <h2 className="text-lg font-semibold">Lazada products</h2>
